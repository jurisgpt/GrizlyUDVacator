...
class BeautifulSoup(Tag):
    ...
    is_xml: bool
    known_xml: bool | None
    parse_only: SoupStrainer | None  #: :meta private:

    # These members are only used while parsing markup.
    markup: _RawMarkup | None  #: :meta private:
    current_data: list[str]  #: :meta private:
    currentTag: Tag | None  #: :meta private:
    ...
    _most_recent_element: PageElement | None  #: :meta private:
    ...
    def __init__(
        ...
        from_encoding: _Encoding | None = None,
        exclude_encodings: _Encodings | None = None,
        element_classes: dict[type[PageElement], type[PageElement]] | None = None,
        **kwargs: Any,
    ):
        """Constructor.
        ...
        def deprecated_argument(old_name: str, new_name: str) -> Any | None:
    ...
    def string_container(
        self, base_class: type[NavigableString] | None = None
    ...
    def new_string(
        self, s: str, subclass: type[NavigableString] | None = None
    ) -> NavigableString:
    ...
    def object_was_parsed(
        ...
        most_recent_element: PageElement | None = None,
    ) -> None:
    ...
    def _popToTag(
        self, name: str, nsprefix: str | None = None, inclusivePop: bool = True
    ) -> Tag | None:
    ...
    def decode(
        ...
        **kwargs: Any,
        ...
        if self.is_xml:
            ...
            encoding_part = ""
            declared_encoding: str | None = eventual_encoding
