...
class TreeBuilderForHtml5lib(treebuilder_base.TreeBuilder):
    ...
    parser: html5lib.HTMLParser | None  #: :meta private:
    ...
    def insertDoctype(self, token: dict[str, Any]) -> None:
        ...
        publicId: str | None = cast(Optional[str], token["publicId"])
        systemId: str | None = cast(Optional[str], token["systemId"])
...
class Element(BeautifulSoupNode):
    ...
    def __init__(
        self, element: Tag, soup: "BeautifulSoup", namespace: _NamespaceURL | None
    ):
    ...
    def appendChild(self, node: "BeautifulSoupNode") -> None:
        string_child: NavigableString | None = None
        child: PageElement
