...
class ElementFilter:
    ...
    def __init__(self, match_function: _PageElementMatchFunction | None = None):
    ...
    def find_all(
        self, generator: Iterator[PageElement], limit: int | None = None
    ) -> _QueryResults:
    ...
    def allow_tag_creation(
        self, nsprefix: str | None, name: str, attrs: _RawAttributeValues | None
    ) -> bool:
...
class MatchRule:
    ...
    def __init__(
        ...
        pattern: _RegularExpressionProtocol | None = None,
        function: Callable | None = None,
        present: bool | None = None,
        exclude_everything: bool | None = None,
    ):
    ...
    def _base_match(self, string: str | None) -> bool | None:
...
class SoupStrainer(ElementFilter):
    ...
    def _make_match_rules(
        cls,
        obj: _StrainableElement | _StrainableAttribute | None,
        ...
        if isinstance(obj, (str, bytes)):
            ...
            for o in obj:
                if not isinstance(o, (bytes, str)) and hasattr(o, "__iter__"):
                    ...
                    yield rule_class(exclude_everything=True)
                    continue
                yield from cls._make_match_rules(o, rule_class)
        else:
    ...
    def _attribute_match(
        self,
        attr_value: _AttributeValue | None,
        rules: Iterable[AttributeValueMatchRule],
    ) -> bool:
        attr_values: Sequence[str | None]
        if isinstance(attr_value, list):
            attr_values = attr_value
        else:
            attr_values = [cast(str, attr_value)]

        def _match_attribute_value_helper(attr_values: Sequence[str | None]) -> bool:
            for rule in rules:
