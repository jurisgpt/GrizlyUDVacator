...
class Formatter(EntitySubstitution):
    ...
    language: str | None  #: :meta private:
    entity_substitution: _EntitySubstitutionFunction | None  #: :meta private:
    ...
    def _default(
        self, language: str, value: set[str] | None, kwarg: str
    ) -> set[str]:
    ...
    def __init__(
        ...
        entity_substitution: _EntitySubstitutionFunction | None = None,
        void_element_close_prefix: str = "/",
        cdata_containing_tags: set[str] | None = None,
    ...
    ) -> Iterable[tuple[str, _AttributeValue | None]]:
